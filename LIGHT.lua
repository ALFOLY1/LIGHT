...
print('\n\27[1;34m Welcome to the all-new and powerful Source LIGHT ')
file = io.open("LIGHT", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/LIGHT
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./LIGHT.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S LIGHT -X kill
screen -S LIGHT ./LIGHT
done
]])  
file:close() 
...
if hash or SudoBot(msg) or DevALFOLYW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevALFOLYW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevALFOLYW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevALFOLYW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevALFOLYW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevALFOLYW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevALFOLYW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1283876320) then
var = true  
...
local LIGHT_Msg = ''  
if msgs < 100 then 
LIGHT_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
LIGHT_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
LIGHT_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
LIGHT_Msg = 'متفاعل' 
elseif msgs < 1200 then 
LIGHT_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
LIGHT_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
LIGHT_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
LIGHT_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
LIGHT_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
LIGHT_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
LIGHT_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
LIGHT_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
LIGHT_Msg = 'اسطوره التفاعل'  
end 
return LIGHT_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceLIGHT(msg,data) -- بداية العمل
if msg then
...
if DevALFOLYW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,LIGHT_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevALFOLYW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevALFOLYW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevALFOLYW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevALFOLYW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevALFOLYW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevALFOLYW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevALFOLYW(msg) then 
...
if text == 'تحديث السورس ❃' and DevALFOLYW(msg) then 
os.execute('rm -rf LIGHT.lua')
os.execute('wget https://raw.githubusercontent.com/LIGHTTEAM/LIGHT/master/LIGHT.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس بويكا\n ❃∫ الاصدار » { 6.7v}')
dofile('LIGHT.lua')  
end
if text == 'تحديث المتجر ❃' and DevALFOLYW(msg) then 
  io.popen("mkdir File_Bot")
  io.popen("cd File_Bot && rm -rf ga.lua.1") 
  io.popen("cd File_Bot && rm -rf ga.lua.2") 
  io.popen("cd File_Bot && rm -rf ga.lua.3") 
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LIGHTTEAM/Files_LIGHT/master/File_Bot/ga.lua")  
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LIGHTTEAM/Files_LIGHT/master/File_Bot/rd.lua") 
  send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث \n ❃∫ لديك اخر اصدار للمتجر')
  dofile('LIGHT.lua')  
  end
if text == 'رقم البناء ❃' and DevALFOLYW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اهلاء عزيزي \n رقم البناء خاص بوتك {lua~{m7a29}')
end
if text == 'الاصدار ❃' and DevALFOLYW(msg) then 
  database:del(bot_id..'Srt:Bot') 
  send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس بويكا \n ❃∫ الاصدار »{ 6.7v}')
  end
  if text == 'مطور السورس ❃' and DevALFOLYW(msg) then 
    database:del(bot_id..'Srt:Bot') 
    send(msg.chat_id_, msg.id_,' ❃∫ تنويه : قبل لا تراسل المطور تاكد انو عندك شغله مهمه \n\n المطور -@UU_F0LY ')
    end
if text == 'قناه تحديثات البوت ❃' and DevALFOLYW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/BO6OK) \n ❃∫ [قناه السورس](t.me/BO6OK)')
end
if text == "ضع اسم للبوت ❃" and DevALFOLYW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevALFOLYW(msg) then 
...
if text == 'المشتركين ❃' and DevALFOLYW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevALFOLYW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevALFOLYW(msg) then
...
if text == ("قائمه العام ❃") and DevALFOLYW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevALFOLYW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevALFOLYW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevALFOLYW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevALFOLYW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevALFOLYW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevALFOLYW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevALFOLYW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevALFOLYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevALFOLYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..LIGHTk..''..LIGHT..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevALFOLYW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevALFOLYW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevALFOLYW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevALFOLYW(msg) then
...
local LIGHT1_Msg = database:get(bot_id.."LIGHT1:Add:Filter:Rp2"..text..msg.chat_id_)   
if LIGHT1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if LIGHT_Msg and not Special(msg) then  
local LIGHT_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if LIGHT_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevALFOLYW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevALFOLYW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevALFOLYW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevALFOLYW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevALFOLYW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevALFOLYW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevALFOLYW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevALFOLYW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevALFOLYW(msg) then  
...
database:sadd(bot_id.."LIGHT:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."LIGHT:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_LIGHT = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_LIGHT then 
names_LIGHT = database:smembers(bot_id.."LIGHT:blocname"..msg.chat_id_) or ""
if names_LIGHT and names_LIGHT[1] then 
for i=1,#names_LIGHT do 
if name_LIGHT:match("(.*)("..names_LIGHT[i]..")(.*)") then 
...
database:set(bot_id.."LIGHT:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."LIGHT:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."LIGHT:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."LIGHT:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."LIGHT:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_LIGHTa_new(LIGHT1,LIGHT2)
if LIGHT2 and LIGHT2.first_name_ then 
if LIGHT2.first_name_:match("(.*)"..database:get(bot_id.."LIGHT:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."LIGHT:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local LIGHT_nnn = database:get(bot_id.."LIGHT:nump"..msg.chat_id_) or 5
local LIGHT_nnn2 = database:get(bot_id.."LIGHT:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(LIGHT_nnn2) == tonumber(LIGHT_nnn) or tonumber(LIGHT_nnn2) > tonumber(LIGHT_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."LIGHT:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..LIGHT2.username_.."](https://t.me/"..(LIGHT2.username_ or "BO6OK")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."LIGHT:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(LIGHT_nnn) - tonumber(LIGHT_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_LIGHTa_new)
end
end
...
local LIGHTChengName = database:get(bot_id.."LIGHT:Cheng:Name"..data.id_)
if not data.first_name_ then 
if LIGHTChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..LIGHTChengName..']')
database:del(bot_id.."LIGHT:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if LIGHTChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."LIGHT:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local LIGHTChengUserName = database:get(bot_id.."LIGHT:Cheng:UserName"..data.id_)
if not data.username_ then 
if LIGHTChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..LIGHTChengUserName..']')
database:del(bot_id.."LIGHT:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if LIGHTChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."LIGHT:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local LIGHTChengPhoto = database:get(bot_id.."LIGHT:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if LIGHTChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."LIGHT:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if LIGHTChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."LIGHT:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevALFOLYW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevALFOLYW(msg) then    
dofile('LIGHT.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevALFOLYW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevALFOLYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevALFOLYW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevALFOLYW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevALFOLYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevALFOLYW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevALFOLYW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevALFOLYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevALFOLYW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevALFOLYW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevALFOLYW(msg) then
...
if text == 'الملفات' and DevALFOLYW(msg) then
...
if DevALFOLYW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LIGHTTEAM/Files_LIGHT/master/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevALFOLYW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LIGHTTEAM/Files_LIGHT/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevALFOLYW(msg) then
...
if text == "مسح الملفات" and DevALFOLYW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevALFOLYW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevALFOLYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_LIGHT(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_LIGHT, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_LIGHT, nil)
return false 
end
...
database:set(bot_id.."LIGHT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."LIGHT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."LIGHT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."LIGHT1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."LIGHT1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."LIGHT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."LIGHT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."LIGHT1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."LIGHT1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."LIGHT1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."LIGHT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."LIGHT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."LIGHT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LIGHT1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."LIGHT1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."LIGHT1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."LIGHT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LIGHT1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."LIGHT1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do  
local LIGHT_Msg = database:get(bot_id.."LIGHT1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..LIGHT_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevALFOLYW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevALFOLYW(msg) then
...
if text == 'تفعيل الاذاعه' and DevALFOLYW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevALFOLYW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..LIGHT_Msg[math.random(#LIGHT_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevALFOLYW(msg) then 
...
if text == ("مسح ردود المطور") and DevALFOLYW(msg) then 
...
if text == ("ردود المطور") and DevALFOLYW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevALFOLYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevALFOLYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevALFOLYW(msg) then   
...
if text == 'تعطيل المغادره' and DevALFOLYW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'LIGHT')..') '
...
-- vardump(data) 
LIGHTdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevALFOLYW(msg) then
...
zh = https.request('https://rudi-dev.tk/Amir1/LIGHT.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝘽𝙆━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/LIGHT.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/LIGHT.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
LIGHT = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(LIGHT)
...
--------------------------------------------------------------------------------------------------------------
SourceLIGHT(data.message_,data)
...
------------------------------------------------------------------------
local LIGHTAbot = database:get(bot_id.."LIGHT1:Add:Filter:Rp2"..text..result.chat_id_)   
if LIGHTAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..LIGHTAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local LIGHT1_Msg = database:get(bot_id.."LIGHT1:Add:Filter:Rp2"..text..result.chat_id_)   
if LIGHT1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..LIGHT1_Msg)
